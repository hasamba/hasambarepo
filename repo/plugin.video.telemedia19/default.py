...
class OverlayText:
    def __init__(self):
        ...
        media_path=os.path.join(xbmcvfs.translatePath(Addon.getAddonInfo("path")),'resources','media')
...
def infiniteReceiver(all_d,last_id,archive='chatListMain',chat_filter_id='0'):
   ...
   try:
    ...
    if items!='':
        ...
        aa=addDir3('[COLOR blue]'+Addon.getLocalizedString(32026)+'[/COLOR]',archive,12,'https://sitechecker.pro/wp-content/uploads/2017/12/search-engines.png','https://www.komando.com/wp-content/uploads/2017/12/computer-search.jpg','Next',data='all',last_id=last_id)
        all_d.append(aa)
...
def main_menu():
    ...
    if event['status']==2 or event['status']=='Needs to log from setting':
        ...
        #Movies
        aa=addDir3('[COLOR lime][B]'+Addon.getLocalizedString(32020)+'[/B][/COLOR]',str(id),10,'special://home/addons/plugin.video.telemedia19/tele/movies.png','https://www.ubackground.com/_ph/22/269562231.jpg','Movies')
        all_d.append(aa)
        #Tv Shows
        aa=addDir3('[COLOR lime][B]'+Addon.getLocalizedString(32021)+'[/B][/COLOR]',str(id),11,'special://home/addons/plugin.video.telemedia19/tele/tvshows.png','https://static.highsnobiety.com/thumbor/R8JPAdy4hlfFhZj9_YqCQfcNsZ0=/fit-in/800x480/smart/static.highsnobiety.com/wp-content/uploads/2019/02/28155224/game-of-thrones-season-8-posters-001.jpg','Tv Shows')
        all_d.append(aa)
        # aa=addDir3('[COLOR lime][B]'+Addon.getLocalizedString(32073)+'[/B][/COLOR]','www',31,'special://home/addons/plugin.video.telemedia19/tele/kids.png','https://insidethemagic-119e2.kxcdn.com/wp-content/uploads/2018/08/Expo19_11x16_Poster_KeyArt_72dpi-1-792x400.jpg',Addon.getLocalizedString(32073),data=KIDS_CHAT_ID)
        # all_d.append(aa)
        #My Groups
        aa=addDir3('[COLOR lime][B]'+Addon.getLocalizedString(32022)+'[/B][/COLOR]','chatListMain',12,'special://home/addons/plugin.video.telemedia19/tele/mygroups.png','https://wallup.net/wp-content/uploads/2016/10/12/137743-jumping-silhouette-group_of_people-cat-sea-reflection.jpg','My Groups',last_id='0$$$9223372036854775807')
        all_d.append(aa)
        aa=addDir3('[COLOR lime][B]'+Addon.getLocalizedString(32138)+'[/B][/COLOR]','chatListArchive',12,'special://home/addons/plugin.video.telemedia19/tele/archive.png','https://hdwallpaperim.com/wp-content/uploads/2017/08/23/471244-Brandon_Sanderson-Stormlight_Archives.jpg','My Groups',last_id='0$$$9223372036854775807')
        all_d.append(aa)
        aa=addDir3('[COLOR lime][B]'+Addon.getLocalizedString(32141)+'[/B][/COLOR]','chatListArchive',121,'special://home/addons/plugin.video.telemedia19/tele/folder.png','https://cirasync.com/wp-content/uploads/2019/07/Create-and-Share-PF-O365_featuredimage95-1-1080x630.png','My Folders')
        all_d.append(aa)
        aa=addDir3('[COLOR lime][B]'+Addon.getLocalizedString(32027)+'[/B][/COLOR]',str(id),113,'special://home/addons/plugin.video.telemedia19/tele/search.png','https://seleritysas.com/wp-content/uploads/2019/12/shutterstock_606583169.jpg','Search All',last_id='0$$$0',data='all')
        all_d.append(aa)
        # #Search Groups
        ...
        if len(Addon.getSetting("update_chat_id"))>0:
            #my repo
            aa=addDir3('[COLOR lime]'+Addon.getLocalizedString(32127)+'[/COLOR]','www',46,'special://home/addons/plugin.video.telemedia19/tele/addons.png','https://cdn.wallpapersafari.com/21/48/cRMEy3.jpg',Addon.getLocalizedString(32127))
            all_d.append(aa)
        ...
        all_d.append(aa)
        #Kids World
        aa=addDir3('[COLOR lime]'+Addon.getLocalizedString(32073)+'[/COLOR]','www',31,'special://home/addons/plugin.video.telemedia19/tele/kids.png','https://insidethemagic-119e2.kxcdn.com/wp-content/uploads/2018/08/Expo19_11x16_Poster_KeyArt_72dpi-1-792x400.jpg',Addon.getLocalizedString(32073),data=KIDS_CHAT_ID)
        #all_d.append(aa)
...
def play_link(name,url,icon,fan,no_subs,tmdb,season,episode,original_title):
    if 1:#try:
        ...
        if 'twitch' in final_link:
            twitch_p=os.path.join(xbmcvfs.translatePath("special://home/addons/"),'plugin.video.twitch')
    ...
    if ok:
        ...
        if not xbmc.getCondVisibility("System.HasAddon(%s)" % name.split('-')[0]):
            ...
            if len(missing)>0:
                ...
                return 0
        addon_p=xbmcvfs.translatePath("special://home/addons/")
...
def install_build(original_title,url):
    ...
    addon_p=xbmcvfs.translatePath("special://home")
    zz=0
    for items in f_list:
...
def download_files(name,url):
    ...
    try:
        num=random.randint(0,60000)
        #Install
        new_dest=xbmcvfs.translatePath(Addon.getSetting("remote_path"))
    ...
    if len(names)>0:
        ...
        if selected_group_id!=-1:
            if backup:
                ...
                zip_name = os.path.join(xbmcvfs.translatePath("special://temp"), 'data.zip')
                ...
                db_bk_folder=xbmcvfs.translatePath(Addon.getSetting("remote_path"))
                nameSelect=[]
                logSelect=[]
                import glob
                folder = xbmcvfs.translatePath('special://logpath')
