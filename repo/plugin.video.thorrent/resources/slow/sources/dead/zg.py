                ...
                if int(size)<max_size:
                   ...
                   try:
                       try:
                            ...
                            nam=urllib.parse.unquote_plus(nam).replace('[zooqle.com]','').strip()

                   except:pass

                   all_links.append((nam,links,str(size),'[COLOR deepskyblue]Peer:[/COLOR] %s [COLOR deepskyblue]Seed:[/COLOR] %s'%(peer,seed),res))
