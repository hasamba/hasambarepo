    ...
    for idd in id_table:
     for itt in search_url:
        ...
        for items in x['results']:
                         ...
                         size=items['size']
                         peer=items['leechs']
                         logging.warning('ew4:'+str(items))

                         seed=items['seeds'].replace(",","")
                         logging.warning('44433333'+str(seed))
                         ...
                         if size<max_size:
                           all_links.append((title,link,str(size),'[COLOR deepskyblue]Peer:[/COLOR] %s [COLOR deepskyblue]Seed:[/COLOR] %s'%(peer,seed),res))
