...
def get_links(tv_movie,original_title,season_n,episode_n,season,episode,show_original_year,id):
    ...
    for itt in search_url:
        ...
        x=get_html('https://kick4ss.com/usearch/0}/'.format(itt),headers=base_header,timeout=10).content()
        ...
        for items in m_pre:
            ...
            for link,title,size,seed,peer in macth_pre:
                         ...
                         if size<max_size:
                           ...
                           all_links.append((title,f_link,str(size),'[COLOR deepskyblue]Peer:[/COLOR] %s [COLOR deepskyblue]Seed:[/COLOR] %s'%(peer,seed),res))
