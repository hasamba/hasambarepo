...
# vstream = xbmcaddon.Addon('plugin.video.thorrent')
...
class cClear:
    ...
    def main(self, env):
        ...
        if (env == 'urlresolver'):
            ...
            try:
                sUrl = 'https://raw.githubusercontent.com/Kodi-vStream/venom-xbmc-addons/master/plugin.video.thorrent/changelog.txt'
            ...
            path = "special://home/addons/plugin.video.thorrent"
            ...
            try:
                sUrl = 'https://raw.githubusercontent.com/Kodi-vStream/venom-xbmc-addons/master/plugin.video.thorrent/soutient.txt'
                oRequest = urllib2.Request(sUrl)
                oResponse = urllib2.urlopen(oRequest)
            ...
            if self.DIALOG.VSyesno(self.ADDON.VSlang(30456)):
                cached_Cache = "special://home/userdata/addon_data/plugin.video.thorrent/video_cache.db"
            ...
            cached_DB = "special://home/userdata/addon_data/plugin.video.thorrent/vstream.db"
            # important seul xbmcvfs peux lire le special
            try:
            ...
            class XMLDialog(xbmcgui.WindowXMLDialog):
                ...
                def onInit(self):
                    ...
                    for aPlugin in aPlugins:
                        ...
                        icon = "special://home/addons/plugin.video.thorrent/resources/art/sites/%s.png" % aPlugin[1]
            ...
            DB = "special://home/userdata/addon_data/plugin.video.thorrent/vstream.db"
            if select >= 0:
