...
class cGuiElement:
    ...
    def __init__(self):
        ...
        self.__sRootArt = 'special://home/addons/plugin.video.thorrent/resources/art/'
        self.__sType = 'Video'
        self.__sMeta = 0
        self.__sPlaycount = 0
        self.__sTrailer = ''
        ...
        self.__sFanart = 'special://home/addons/plugin.video.thorrent/fanart.jpg'
...
#        self.__sTitleWatched = sTitleWatched
    ...
    def getIcon(self):
        ...
        folder = 'special://home/addons/plugin.video.thorrent/resources/art'
