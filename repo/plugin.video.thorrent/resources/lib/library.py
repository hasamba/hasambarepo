...
class cLibrary:
    ...
    def __init__(self):
        ...
        if not self.__sMovieFolder:
            self.__sMovieFolder = 'special://userdata/addon_data/plugin.video.thorrent/Films'
        ...
        if not self.__sTVFolder:
            self.__sTVFolder = 'special://userdata/addon_data/plugin.video.thorrent/Series'
    ...
    def setLibrary(self):
        ...
        sLink = 'plugin://plugin.video.thorrent/?function=play&site=cHosterGui&sFileName=' + sFileNameEncode + '&sMediaUrl=' + sMediaUrl + '&sHosterIdentifier=' + sHosterIdentifier
    ...
    def getLibrary(self):
        xbmc.executebuiltin('Container.Update(special://userdata/addon_data/plugin.video.thorrent/)', True)
        return True
