...
# sLibrary = xbmc.translatePath('special://home/addons/plugin.video.thorrent').decode('utf-8')
        ...
        if dialogs.VSyesno(addons.VSlang(30456)):
            ...
            if result:
                ...
                for i in result['files']:
                    ...
                    if 'plugin.video.thorrent' in i['filename']:
                ...
                icon = 'special://home/addons/plugin.video.thorrent/resources/art/update.png'
