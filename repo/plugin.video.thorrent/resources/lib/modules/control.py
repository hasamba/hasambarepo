...
transPath = xbmc_tranlate_path

skinPath = xbmc_tranlate_path('special://skin/')

addonPath = xbmc_tranlate_path(addonInfo('path'))
...
def installAddon(addonId):
    ...
    addonPath = os.path.join(xbmc_tranlate_path('special://home/addons'), addonId)
