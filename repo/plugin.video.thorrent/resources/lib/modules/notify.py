...
icon                = xbmc_tranlate_path(os.path.join('special://home/addons/' + ADDON_ID, 'icon.jpg'))
setting             = xbmcaddon.Addon().getSetting
addonInfo           = xbmcaddon.Addon().getAddonInfo
HOME                = xbmc_tranlate_path('special://home/')
XXX_SETTINGS        = xbmc_tranlate_path(os.path.join('special://home/userdata/addon_data/' + ADDON_ID,'settings.xml'))
PARENTAL_FOLDER     = xbmc_tranlate_path(os.path.join('special://home/userdata/addon_data/' + ADDON_ID , 'parental'))
DATA_FOLDER         = xbmc_tranlate_path(os.path.join('special://home/userdata/addon_data/' + ADDON_ID))
ADDON_FOLDER        = xbmc_tranlate_path(os.path.join('special://home/addons/' + ADDON_ID))
...
ART            = xbmc_tranlate_path(os.path.join('special://home/addons/' + ADDON_ID , 'resources', 'art'))
...
I_AGREE        = xbmc_tranlate_path(os.path.join(DATA_FOLDER , 'agreed.txt'))
BACKGROUND     = xbmc_tranlate_path(os.path.join('special://home/addons/' + ADDON_ID , 'resources', 'art', 'ContentPanel.png'))
FONTHEADER     = 'Font14'
HEADERIMAGE    = ''
FONTSETTINGS   = 'Font12'
HEADERTYPE     = 'Text'
