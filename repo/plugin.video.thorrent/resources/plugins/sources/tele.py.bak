...
def get_links(tv_movie,original_title,season_n,episode_n,season,episode,show_original_year,id):
    ...
    if 1:#try:
        ...
        if tv_movie=='movie':
            ...
            log.warning('search:'+original_title)
        ...
        log.warning('start telemedia:'+progress)
        return global_var
