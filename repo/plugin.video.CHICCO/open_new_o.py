...
def getMediaLinkForGuest_new(url):
    ...
    page_code=re.compile(regex).findall(sHtmlContent1)[0]
    #regex_c="window.ffff='(.+?)';.+?case'7':(.+?);continue;.+?_0x531f91=(.+?);continue;"
    #match_c=re.compile(regex_c,re.DOTALL).findall(code)
    #for match_r3,match_r1,match_r2 in match_c:
    #   print 'yes'
