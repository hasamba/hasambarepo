...
def get_links(tv_movie,original_title,sedason_n,episode_n,season,episode,show_original_year,id):
    ...
    if tv_movie=='tv':
        ...
        headers = {
            ...
            'user-agent': 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/102.0.5005.61 Safari/537.36',
        }
        ...
        response = get_html('https://www.2embed.ru/embed/imdb/movie', params=params, headers=headers).content()
