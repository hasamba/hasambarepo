...
def get_links(tv_movie,original_title,season_n,episode_n,season,episode,show_original_year,id):
    ...
    if 1:
        ...
        x=get_html('https://1337xmovies.org/search?s='+(search_url),headers=base_header,timeout=10,verify=False).content()
                ...
                if tv_movie=='tv':
                    ...
                    for itt,tt in nn:
                        ...
                        if 'season %s episode %s '%(season,episode) in tt:
                            ...
                            y=get_html(itt,headers=base_header,timeout=10,verify=False).content()
