...
def main_menu():
    ...
    all_d.append(addDir3('[COLOR lightblue](%s) סרטים שנצפו[/COLOR]'%str(len(all_firebase)),'0',10,'https://icons.iconarchive.com/icons/sirubico/movie-genre/256/Children-icon.png','https://i.ytimg.com/vi/9FQgg_h_lcQ/maxresdefault.jpg','נצפו','נצפו'))
    ...
    all_d.append(addDir3('סדרות מדובבות','www',57,'https://www.netclipart.com/pp/m/186-1868147_kids-logo-tv-show-logos-childrens-logo-church.png','https://i.ytimg.com/vi/s5kNa7KN7NQ/hqdefault.jpg','חפש'))
    
    
    
    all_d.append(addLink( '[COLOR yellow][I]הגרל לי סדרה[/I][/COLOR]',  'www',16,False,'https://images-na.ssl-images-amazon.com/images/I/51JqWrL9jGL._SY355_.png','https://images-na.ssl-images-amazon.com/images/I/614xI2W%2BJTL.png','הגרל לי סדרה'))
    ...
    match = dbcur.fetchall()
    for name ,url ,video_info ,id ,icon ,fan ,free in match:
        x=json.loads(unque(video_info))
   
        
        all_d.append(addLink(name.replace('%27',"'")+'[COLOR yellow][B][I]'+x['original_title']+'- [/I][/B][/COLOR]',url,5,False,icon,fan,free.replace('%27',"'"),video_info=unque(video_info),id=id))
    ...
    addNolink( '[COLOR yellow][I]עדכן הכל[/I][/COLOR]', 'www',6,False, iconimage="https://i.ytimg.com/vi/6sRi1FvWe1Q/maxresdefault.jpg",fan='https://i.ytimg.com/vi/DZj9lWmqbus/hqdefault.jpg',sys_arg_1_data=sys_arg_1_data)
    ...
    addNolink( '[COLOR yellow][I]עדכן סדרות[/I][/COLOR]', 'tv',6,False, iconimage="https://i.ytimg.com/vi/6sRi1FvWe1Q/maxresdefault.jpg",fan='https://i.ytimg.com/vi/DZj9lWmqbus/hqdefault.jpg',sys_arg_1_data=sys_arg_1_data)
